...
FROM
    NorthwindTables
';
$TotalTable = $dbh->query($TotalTableQuery);
...
FROM
    NorthwindViews
';
$TotalView = $dbh->query($TotalViewQuery);
...
FROM
    NorthwindFunction
';
$TotalFunction = $dbh->query($TotalFunctionQuery);
...
';
$TotalProcedure = $dbh->query($TotalProcedureQuery);
...
FROM
    NorthwindTriggers
';
$TotalTrigger = $dbh->query($TotalTriggerQuery);
